...
public class Adresse implements Serializable, Comparable<Adresse> {
    ...
    private Set<Covoiturage> covoituragesDepart = new HashSet<>();

    /** Covoiturages possédant cette adresse comme point d'arrivée */
    @OneToMany(mappedBy = "adresseArrivee")
    private Set<Covoiturage> covoituragesArrivee = new HashSet<>();
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder(this.numero);
        sb.append(" ").append(this.rue);
        sb.append(", ").append(this.codePostal);
        sb.append(" ").append(this.ville);
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return this.id == autreAdresse.id
            && Objects.equals(this.numero, autreAdresse.numero)
            && Objects.equals(this.rue, autreAdresse.rue)
            && Objects.equals(this.codePostal, autreAdresse.codePostal)
            && Objects.equals(this.ville, autreAdresse.ville);
    }

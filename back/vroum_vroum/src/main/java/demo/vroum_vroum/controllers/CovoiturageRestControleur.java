...
public class CovoiturageRestControleur {
    ...
    public ResponseEntity<Set<CovoiturageDto>> getMesReservations(@RequestParam int idCollaborateur) {
    ...
    public ResponseEntity<Void> reserverCovoit(@PathVariable int idReservation, @PathVariable int idCollaborateur) {

...
public class CollaborateurRestControleurTest {
    ...
    private final List<CollaborateurLiteDto> collaborateursLiteDto =  new ArrayList<CollaborateurLiteDto>(List.of(
    ...
    void testGetCollaborateurById_shouldReturnUser_roleAdmin() throws Exception {
        when(collaborateurRepo.findById(3)).thenReturn(Optional.of(this.collaborateursMocked.get(2)));
    ...
    void testGetCollaborateurById_shouldRetur404_badId() throws Exception {
        when(collaborateurRepo.findById(4)).thenReturn(Optional.empty());
    ...
    void testGetCurrentUserLite_shouldreturnConnectedUser() throws Exception {
        when(collaborateurRepo.findByPseudo("mmartin")).thenReturn(Optional.of(this.collaborateursMocked.get(1)));
